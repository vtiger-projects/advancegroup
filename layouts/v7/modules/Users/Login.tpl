...
/*			background: url(layouts/v7/resources/Images/login-background.jpg);*/
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #003990 0px, #003990 100%)
		}
		.ripples {
			position: absolute;
			top: 0;
...
<!-- <img class="img-responsive user-logo" src="test/upload/images/logo-advance.png"> -->
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #15c;">Recuperar contraseña?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Por favor ingrese los detalle y envie<a class="forgotPasswordLink pull-right" style="color: #15c;">Atras</a></span>
						</div>
					</form>
				</div>
			</div>
