...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'http://www.clientes.advancegroup.com.co/crm',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'http://www.clientes.advancegroup.com.co/crm/portal',
	...
	protected static function getData() {
		...
		self::$data['ui.Language'] = array('label' => 'ES Spanish', 'value' => 'es_es');
